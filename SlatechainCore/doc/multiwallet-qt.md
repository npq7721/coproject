...
In order to support loading of multiple wallets in corallium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is corallium.cpp.
...
Changes to corallium.cpp
----------------------
corallium.cpp is the entry point into corallium-qt, and as such, will require some minor modifications to provide hooks for
