...
*Setup instructions for a gitian build of CRLM using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the CRLM
...
- [Building CRLM](#building-corallium)
...
git clone https://github.com/corallium-crypto/corallium.git
cd corallium
...
To build CRLM (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/corallium-crypto/corallium
...
For example:
```bash
URL=https://github.com/crowning-/corallium.git
...
[corallium/gitian.sigs](https://github.com/corallium-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
