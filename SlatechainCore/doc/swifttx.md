...
This mechanism has been integrated into Bitcore-Node-CRLM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CRLM-Project/insight-api-corallium#web-socket-api](https://github.com/CRLM-Project/insight-api-corallium#web-socket-api) 
* API: [https://github.com/CRLM-Project/insight-api-corallium#swifttx-transactions](https://github.com/CRLM-Project/insight-api-corallium#swifttx-transactions) 
...
By default, the CRLM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CRLM Core daemon:
