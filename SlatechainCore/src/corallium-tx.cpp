...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CRLM Core corallium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  corallium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded corallium transaction") + "\n" +
                               "  corallium-tx [options] -create [commands]   " + _("Create hex-encoded corallium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded corallium transaction
