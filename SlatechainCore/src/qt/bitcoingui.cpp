                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CRLM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CRLM Core"), this);
    aboutAction->setStatusTip(tr("Show information about CRLM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CRLM"));
    ...
    openAction->setStatusTip(tr("Open a CRLM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CRLM Core help message to get a list with possible CRLM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CRLM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CRLM network", "", count));
}
...
{
    QString strTitle = tr("CRLM Core"); // default title
