...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (0, uint256("00000d152560833a289842b1a6923d126bf8600099d535e57bb9b7dcb6bc5197"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1531236651, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 13888;
        bnProofOfWorkLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000"); // CRLM starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 30; // CRLM: every blk
        nTargetSpacing = 30;  // CRLM: 120 seconds
        nLastPOWBlock = 200;
        nMaturity = 50;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 615800;
        nMaxMoneyOut = 14500000 * COIN;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1531236651;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 14142722;
	
        //MineGenesis(genesis);

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000d152560833a289842b1a6923d126bf8600099d535e57bb9b7dcb6bc5197"));
        assert(genesis.hashMerkleRoot == uint256("70d1038b4bb301e764211822c457b7678ffdd9d2ec7ac83d70b4421def75c55e"));
...
//        convertSeed6(vFixedSeeds, pnSeed6_main, ARRAYLEN(pnSeed6_main));
        ...
        strSporkKey = "03e2010484008efdebe07a56f937b21c1e397471b8d8a0b6ea5e54e581a8aae655";
        strObfuscationPoolDummyAddress = "D87q2gC9j6nNrnzCsg4aY6bHMLsT9nUhEw";
        nStartMasternodePayments = 500; // Start after 2000 blocks
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // CRLM: 1 day
        nTargetSpacing = 5 * 60;  // CRLM: 5 minutes
        nLastPOWBlock = 200;
        nMaturity = 15;
...
//        assert(hashGenesisBlock == uint256("0x000005b346bed6717056a1e45e6cd371e7be408ca19220445b5cd608925dbf12"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "corallium-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "corallium-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet CRLM addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet CRLM script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet CRLM BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet CRLM BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet CRLM BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CRLM: 1 day
        nTargetSpacing = 1 * 60;        // CRLM: 1 minutes
