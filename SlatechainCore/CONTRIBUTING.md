Contributing to Corallium Core
============================

The Corallium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Corallium Core project, and is not to be
confused with overall Corallium Network Protocol consensus changes.

Whether a pull request is merged into Corallium Core rests with the project merge
...
Patches that change Corallium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Corallium consensus, it must have been
...
The project leader is the release manager for each Corallium Core release.
